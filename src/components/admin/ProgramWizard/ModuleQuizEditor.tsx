...
export default function ModuleQuizEditor({
  ...
  const [localQuiz, setLocalQuiz] = useState<ModuleQuiz>(
    quiz || createDefaultQuiz(moduleTitle)
  );
  ...
  // Calculate stats
  const totalMarks = localQuiz.questions.reduce((sum, q) => sum + q.marks, 0);
  const questionCount = localQuiz.questions.length;
  ...
  return (
    <div className="border border-indigo-200 rounded-xl overflow-hidden bg-gradient-to-br from-indigo-50 to-white">
      {/* Header */}
      <div
        className="flex items-center justify-between p-4 bg-gradient-to-r from-indigo-500 to-purple-600 cursor-pointer"
        onClick={() => setIsExpanded(!isExpanded)}
      >
        <div className="flex items-center gap-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateQuiz({ passingScore: parseInt(e.target.value) || 60 })
                    }
                    className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                  />
                </div>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          updateQuiz({
                            negativeMarkingEnabled: parseInt(e.target.value) > 0,
