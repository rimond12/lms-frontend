        ...
        <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-700 p-8 text-white relative overflow-hidden">
          ...
          <div className="relative z-10 flex items-center gap-4">
            <div className="p-3 bg-white/10 backdrop-blur-md rounded-xl border border-white/20">
              <KeyRound className="w-8 h-8 text-blue-200" />
            </div>
            <div>
              <h1 className="text-2xl font-bold tracking-tight">Account Password Security</h1>
              <p className="text-blue-100 text-sm mt-1">
                Change your account password securely from your profile
              </p>
            </div>
          </div>
        </div>
          ...
          <ImmigrantForm key={formKey} onSubmit={onSubmit}>
            ...
            <div className="mt-6 p-4 rounded-xl bg-blue-50/60 border border-blue-100 flex items-start gap-3">
              ...
              <p className="text-xs text-blue-900 leading-relaxed">
                Password should be at least 6 characters long. Keep your account password strong and secure.
              </p>
            </div>
            ...
            <div className="mt-8">
              <Button
                className="w-full py-3.5 text-base font-semibold text-white bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all shadow-md hover:shadow-lg transform active:scale-[0.99] disabled:opacity-75"
                size="lg"
                type="submit"
                disabled={isPending}
              >
